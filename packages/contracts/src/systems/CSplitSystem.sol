...
import { Position, Type, PositionData, PositionTableId, ReadyBlock, StartBlock, RealmId, RealmIdTableId, Energy, ResourceConnection, ControlConnection, GameConfigData, GameConfig, Voted, Counter } from "../codegen/Tables.sol";
