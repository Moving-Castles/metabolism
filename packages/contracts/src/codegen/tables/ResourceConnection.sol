...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("mc"), bytes16("ResourceConnecti")));
bytes32 constant ResourceConnectionTableId = _tableId;

library ResourceConnection {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ResourceConnection", _fieldNames);
  }
