...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("mc"), bytes16("ControlConnectio")));
bytes32 constant ControlConnectionTableId = _tableId;

library ControlConnection {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ControlConnection", _fieldNames);
  }
